  ...
  <div class="osnovnoe">
    ...
    <div class="container">
      ...
      <form @submit.prevent="transferMoney">
        <div class="perevod">
          <label style="color: darkslateblue">Номер телефона получателя</label><br>
        ...
        <div class="sum">
          <input placeholder="От 1 ₽ до 200 000 000 ₽" style="color: darkslateblue" class="vvod_1" type="text" v-model="amount" required><br>
        </div>
